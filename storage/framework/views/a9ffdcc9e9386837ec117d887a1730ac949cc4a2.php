...
<div class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo e(route('homeInvite')); ?>">Serious Game premiers secours</a>
        </div>
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right" >
                <li><a href="<?php echo e(route('invite.scenarios')); ?>">Jeux</a></li>
                <?php
                if (Auth::guard('invites')->check())
                {
                ?>
                <li><a href="<?php echo e(route('invite.cours')); ?>">Mon cours</a></li>
                <li><a href="<?php echo e(route('invite.logout')); ?>">Se déconnecter</a></li>
