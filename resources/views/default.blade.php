...
<div class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ route('home') }}">Serious Game premiers secours</a>
        </div>
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="{{ route('classement') }}">Classement</a></li>
                <li><a href="{{ route('scenarios') }}">Jeux</a></li>
                <?php
                if (Auth::check())
                {
                ...
                <li><a href="{{ route('user.index') }}">Gérer les utilisateurs</a></li>
                <?php
                }
                else if ($role == 2)
                {
